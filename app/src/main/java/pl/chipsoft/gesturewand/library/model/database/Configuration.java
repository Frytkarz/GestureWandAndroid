...
public class Configuration {
    ...
    public static final int SAMPLES_COUNT_MIN = 20;
    public static final int SAMPLES_COUNT_MAX = 200;
    public static final int MAX_ERROR_MIN = 2;
    public static final int MAX_ERROR_MAX = 7;
